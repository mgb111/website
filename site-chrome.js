      ...
      <div class="max-w-7xl mx-auto flex flex-wrap justify-between items-center">
        <div class="flex items-center ml-3 md:-ml-6">
          <a href="index.html" class="flex items-center">
            <img src="majorbean-logoform.png" alt="majorbeam logo" class="mr-4 md:mr-2 h-8 w-8 object-contain">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-12 py-16 md:justify-items-center items-center">
          <div class="text-left col-span-2 md:col-span-1 order-1">
            <div class="flex items-center mb-6">
              <img src="majorbean-logoform.png" alt="majorbeam logo" class="mr-4 md:mr-2 h-8 w-8 object-contain align-middle">
