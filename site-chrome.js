      ...
      <div class="max-w-7xl mx-auto flex flex-wrap justify-between items-center">
        <div class="flex items-center md:-ml-6">
          <a href="index.html" class="flex items-center">
            <img src="majorbean-logoform.png" alt="majorbeam logo" class="mr-8 h-9 w-9 object-contain">
        ...
        <div class="grid md:grid-cols-3 gap-12 py-16 md:justify-items-center">
          <div class="text-center">
            <div class="flex items-center justify-center mb-6">
              <img src="majorbean-logoform.png" alt="majorbeam logo" class="mr-8 h-9 w-9 object-contain align-middle">
